...
# In this Configuration every function is going to return an entity 
from housing.entity.config_entity import DataIngestionConfig,DataValidationConfig,DataTransformationConfig, \
ModelTrainingConfig,ModelPusherConfig,ModelEvaluationConfig,TrainingPipelineConfig
...
class Configuration : 
    ...
    def get_data_validation_config(self)-> DataValidationConfig:
        try :
            ...
            logging.info(f"Data Valiation Config is {data_validation_config}")
    ...
    def get_data_transformation_config(self) ->DataTransformationConfig :
        try :
            ...
            logging.info(f"Data Tranformation Config created : {data_transformation_confg}")
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        try :
            ...
            response = ModelEvaluationConfig(model_evaluaiton_file_path=model_evaluation_file_path,
    ...
    def get_model_pusher_config(self) -> ModelPusherConfig:
        try :
            ...
            model_pusher_config_info[MODEL_PUSHER_MODEL_EXPORT_DIR_KEY],time_stamp)
