...
class Pipeline (Thread):
    ...
    """ Threads are a way to achieve concurrency in Python programs.
    They allow a program to execute multiple sequences of instructions 
    (tasks) apparently simultaneously.
    This can be useful for performing long-running operations or handling 
    multiple requests without blocking the main program flow."""

    experiment : Experiment = Experiment(*([None]*11))

    """This code defines a call to the Experiment function, providing an empty list of 
    11 None values as arguments. It's likely used in a scenario where Experiment can 
    handle an optional set of arguments, and if no arguments are explicitly provided, 
    the function will use these defaults (None)."""
    ...
    data_validation_artifact : DataValidationArtifact) -> DataTransformationArtifact:
        try:
            ...
            return data_transformation.initiate_data_transforamtion()
        except Exception as e :
            raise HousingException(e,sys) from e 
    ...
    def run_pipeline(self) :
        try:
            ...
            #  if the pipeline status is false then :
    ...
    def save_experiment(self):
        ...
        """"
        This function saves the Experiment named tuple into Experiment.csv file
