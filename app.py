...
from housing.constant import get_current_time_stamp,CONFIG_DIR
...
def render_artifact_dir(req_path):
    ...
    # joining the base nad requested path
    ...
    # This code provides a function that can handle both scenarios:
    # If the path points to an HTML file, it reads the content and returns it as a string.
    # If the path points to a non-HTML file or there's an error reading the HTML, it likely returns the file itself for download or appropriate handling.
